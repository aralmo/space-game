public static class Test
{
    public static Simulation DefaultSimulation()
    {
        ...
        var planet = CelestialBody
            .CreateCelestial(centralBody: sun, radius: 2000f, mass: 900f,time: simulation.SimulationTime, eccentricity: 0.05f)
        ...
        simulation
            ...
            .AddOrbitingBody(CelestialBody
                .CreateCelestial(centralBody: planet, radius: 85f, mass: 90f,time: simulation.SimulationTime, argumentOfPeriapsis: -1.5f)
                .WithModelVisuals(model: PlanetGenerator.GeneratePlanet(PlanetSettings.Moon, 2), size: 1f)
                .WithInfo(name: "Aeon-1A"))
            .AddOrbitingBody(CelestialBody
                .CreateCelestial(centralBody: planet, radius: 220f, mass: 100f,time: simulation.SimulationTime,.1f, 1.7f,Math.PI)
